                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{!! asset('assets/images/image-6.png') !!}" alt="Logo"
                                                                            title="Logo"
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-font-size"
                                                                ...
                                                                <span><span><span><span><strong>New Online
                                                                                    Reservation</strong></span></span></span></span>
                                                            </h1>
                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{!! asset('assets/images/email/image-7.png') !!}"
                                                            ...
                                                            <div class="v-font-size"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 190%;"><span
                                                                        style="font-size: 18px; line-height: 34.2px;"><strong><span
                                                                                style="line-height: 34.2px; font-size: 18px;">Dari {{$data['name'] ?? ''}},</span></strong></span></p>
                                                                <p style="line-height: 190%;"><span
                                                                        style="font-size: 16px; line-height: 30.4px;">Hello
                                                                        Caredoc, I want to make a reservation for
                                                                        consultation. Here my contacts : </span></p>
                                                                <ul>
                                                                    <li style="line-height: 30.4px;"><span
                                                                            style="font-size: 16px; line-height: 30.4px;">Email: {{ $data['email'] ?? '' }}</span></li>
                                                                    <li style="line-height: 30.4px;"><span
                                                                            style="font-size: 16px; line-height: 30.4px;">Telp: {{ $data['hp'] ?? ''}}</span></li>
                                                                    <li style="line-height: 30.4px;"><span
                                                                            style="font-size: 16px; line-height: 30.4px;">Complaint: {{ $data['complaint'] ?? ''}} </span></li>
                                                                </ul>
                                                            </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            align="left">
                                                            <div class="v-font-size"
                                                                style="font-size: 14px; color: #27187e; line-height: 200%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 200%;"><span
                                                                        style="font-size: 18px; line-height: 36px;"><strong>{{\Carbon\Carbon::now()->format('l, F d \a\t h:i A')}}</strong></span></p>
                                                            </div>
                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{!! asset('assets/images/email/image-4.png') !!}"
                                        ...
                                        <div
                                            ...
                                            <table style="font-family:'Montserrat',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:57px 10px 20px;font-family:'Montserrat',sans-serif;"
                                                            align="left">
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="center" valign="middle"
                                                                                    ...
                                                                                    <a href="https://twitter.com/"
                                                                                        title="Twitter"
                                                                                        target="_blank">
                                                                                        <img src="{!! asset('assets/images/email/image-1.png') !!}"
                                                                                            alt="Twitter"
                                                                                            title="Twitter"
                                                                                            width="32"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="center" valign="middle"
                                                                                    ...
                                                                                    <a href="https://instagram.com/"
                                                                                        title="Instagram"
                                                                                        target="_blank">
                                                                                        <img src="{!! asset('assets/images/email/image-2.png') !!}"
                                                                                            alt="Instagram"
                                                                                            title="Instagram"
                                                                                            width="32"
                                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="center" valign="middle"
                                                                                    ...
                                                                                    <a href="https://linkedin.com/"
                                                                                        title="LinkedIn"
                                                                                        target="_blank">
                                                                                        <img src="{!! asset('assets/images/email/image-3.png') !!}"
                                                                                            alt="LinkedIn"
                                                                                            title="LinkedIn"
                                                                                            width="32"
                                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-font-size"
                                                                style="font-size: 14px; color: #908f8f; line-height: 190%; text-align: center; word-wrap: break-word;">
                                                                ...
                                                                <p style="font-size: 14px; line-height: 190%;">© {{\Carbon\Carbon::now()->format('Y')}}
